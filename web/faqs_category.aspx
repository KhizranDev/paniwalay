<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="faqs_category.aspx.cs" Inherits="faqs_category" %>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <button class="btn btn-primary" onclick="window.location='add_faq_category.aspx';">
                                    Add FAQ Category</button></li>
                        </ul>
                        <div class="clearfix">
                        </div>
                    </div>
    ...
    <script>
        ...
        function Delete(id) {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                url: "RequestHandler.ashx?action=delete_faqs_category",
                cache: false,
                dataType: 'text',
                data: {
                    "id": id
                ...
                success: function (data) {
                    ...
                    setTimeout(function () {
                        window.location.href = "faqs_category.aspx";
                    }, 2000);
