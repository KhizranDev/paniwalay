                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                             <li>
                                <button class="btn btn-warning" onclick="window.location='locations_archive.aspx';">
                                    Archive Locations</button></li>
                            <li>
                                <button class="btn btn-primary" onclick="window.location='add_location.aspx';">
                                    Add Location</button></li>
                        </ul>
                        <div class="clearfix">
                        </div>
                    </div>
