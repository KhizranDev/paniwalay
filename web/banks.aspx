<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="banks.aspx.cs" Inherits="banks" %>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <button class="btn btn-primary" onclick="window.location='add_bank.aspx';">
                                    Add Bank</button></li>
                        </ul>
                        <div class="clearfix">
                        </div>
    ...
    <script>
        ...
        function Delete(id) {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                url: "RequestHandler.ashx?action=delete_bank",
                cache: false,
                dataType: 'text',
                data: {
                    "id": id
                ...
                success: function (data) {
                    ...
                    setTimeout(function () {
                        window.location.href = "banks.aspx";
                    }, 2000);
