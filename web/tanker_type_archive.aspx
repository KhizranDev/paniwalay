<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tanker_type_archive.aspx.cs" Inherits="tanker_type_archive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
    ...
    <div class="noty_bar noty_theme_default noty_layout_top noty_error NotificationDiv"
        ...
        <div class="noty_message">
            <span class="noty_text">Tanker Type Exist in Order</span>
        </div>
    </div>
    <div class="noty_bar noty_theme_default noty_layout_top noty_success NotificationDiv"
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Tanker Type List Archive</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <button class="btn btn-primary" onclick="window.location='tanker_type.aspx';">
                                    Back</button></li>
                        </ul>
                        <div class="clearfix">
                        </div>
    ...
    function Delete(id) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                setTimeout(function () {
                    window.location.href = "tanker_type_archive.aspx";
                }, 2000);
