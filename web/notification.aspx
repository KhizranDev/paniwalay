                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
                                <button class="btn btn-primary" onclick="window.location='add_notification.aspx';">
                                    Add Notification</button></li>
                        </ul>
                        <div class="clearfix">
                        </div>
                    </div>
    ...
    <script>
        ...
        function Delete(id) {
            ...
            jQuery.ajax({
                ...
                type: "POST",
                url: "RequestHandler.ashx?action=delete_notification",
                cache: false,
                dataType: 'text',
                data: {
                    "id": id
